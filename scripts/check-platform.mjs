...
const checks = [
  ...
  ['src/plugins/data/public/index.ts', '  SearchBar,'],
  ['src/plugins/data/public/index.ts', 'mapAndFlattenFilters,'],
  ['src/plugins/data/public/ui/search_bar/search_bar.tsx', '(!this.useNewHeader || this.props.filters.length > 0)'],
  ['src/plugins/data/public/ui/search_bar/search_bar.tsx', '{!isEnhancementsEnabledOverride && filterBar}'],
  ['src/plugins/data/public/ui/search_bar/search_bar.tsx', 'this.services.uiSettings.get(UI_SETTINGS.QUERY_ENHANCEMENTS_ENABLED)'],
  ['src/plugins/data/common/constants.ts', "NEW_HOME_PAGE: 'home:useNewHomePage'"],
  ['src/plugins/data/common/constants.ts', "QUERY_ENHANCEMENTS_ENABLED: 'query:enhancements:enabled'"],
