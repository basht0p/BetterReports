...
**Latest release: [v0.0.3](https://github.com/basht0p/BetterReports/releases/tag/v0.0.3).** Download both plugin ZIPs and their SHA-256 checksums from the release. The plugin version is `0.0.3`; `3.8.0` in the archive filenames identifies the required OpenSearch platform version.
