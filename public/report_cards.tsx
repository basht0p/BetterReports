  ...
  return <div className="br-cards">{reports.map(report => {
    ...
    return <article className="br-report-card" key={report.id} style={{ borderTopColor: `${accent}55` }}>
      <div className="br-card-identity">
        {branding?.logo && <img className="br-card-logo" src={branding.logo} alt="" />}
        <div><span className="br-eyebrow">PDF REPORT · LETTER</span>
      ...
      <div className="br-actions">
        <EuiButton disabled={busy || switchTenant} onClick={() => onOpen(report)}>Open report</EuiButton>
